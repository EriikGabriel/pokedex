  ...
  return (
    <div
      ...
      className={cn(
        ...
        !flip && "rotate-y-180 left-0 z-[2] cursor-pointer",
        className,
      )}
      {...props}
    >
      {flip && (
        <>
          <div className="absolute bottom-[1vmin] left-[1vmin] h-[36.4vmin] w-[27vmin] rounded-[5px] rounded-tr-none border-[0.2px] border-black">
            <div className="absolute left-[2vmin] top-[2.8vmin] z-[2] h-[7vmin] w-[23vmin] rounded-[3px] border-[0.3px] border-black bg-pokedex-gray" />
          ...
          <div className="absolute left-[5.9vmin] top-[-2.1vmin] z-[1] h-[8.5vmin] w-[6.4vmin] rotate-[39.4deg] rounded-tr-[0.3px] border-t-[0.2px] border-t-black bg-pokedex-red" />
      ...
      <div className="absolute -top-[3.075vmin] left-[6.2vmin] h-[7.5vmin] w-[6.7vmin] rotate-[38.9deg] rounded-tr-[0.3px] border-t-[0.2px] border-t-black bg-pokedex-red" />
      ...
      {!flip && (
        <>
          <div className="arrow before:arrow absolute right-2.5 top-2/4 h-[45px] w-[45px] -translate-y-[80%] translate-x-2 bg-black before:absolute before:left-1 before:top-0.5 before:h-10 before:w-10 before:bg-yellow-500 before:content-['']" />
          <div className="absolute bottom-[30px] left-2/4 h-[1vmin] w-[10vmin] -translate-x-2/4 -translate-y-2/4 rounded-[25px] border-[0.2px] border-black bg-pokedex-red" />
        </>
      )}
    </div>
  );
